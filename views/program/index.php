...
// Вычисляем дату старта нового тура.
$date = new DateTime();
...
<section class="container organizer__programs">
    ...
    <div class="programs__block">
        <?php if (empty($programs)): ?>
            <div class="no-programs">Создай и заполни программу тура<br>
                <p>Если не знаешь с чего начать, то загляни в <a href="/support/knowledge-base#how-to-publish" class="link">базу знаний</a></p>
            </div>
        <?php else: ?>
    ...
    <div class="programs__bottom">
        ...
        <div class="btn-grey">
            <a href="/programs/archive">Архив</a>
        </div>
...
<div id="add-new-date" class="body-disable hide-element">
    <div class="new-tour-list">
        ...
        <form action="#" id="form-new-tour" data-program-id="">
            <div class="group">
                <input id="tour-start-at" type="date" name="" data-placeholder="дд.мм.гггг" required aria-required="true" value>
               <!-- <span class="form-comment red"></span>-->
            </div>
            <span class="form-comment red"></span>
