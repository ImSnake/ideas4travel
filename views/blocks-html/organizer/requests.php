...
<!--    <div class="requests-table">
        ...
        <div class="requests-table__row">
            ...
            <div class="requests-table__program">
                <img class="requests-table__img" src="../../images/tours/mini/tour_00001.jpg" alt="tour-img">
        ...
        <div class="requests-table__row">
            ...
            <div class="requests-table__program">
                <img class="requests-table__img" src="../../images/tours/mini/tour_00004.jpg" alt="tour-img">
        ...
        <div class="requests-table__row">
            ...
            <div class="requests-table__program">
                <img class="requests-table__img" src="../../images/tours/mini/tour_00007.jpg" alt="tour-img">
        ...
        <div class="requests-table__row">
            ...
            <div class="requests-table__program">
                <img class="requests-table__img" src="../../images/tours/mini/tour_00010.jpg" alt="tour-img">
