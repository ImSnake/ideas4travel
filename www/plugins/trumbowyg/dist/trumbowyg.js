/**
 * Attention(find this tag)!!! Source code was changed!!!
 *
    ...
    var Trumbowyg = function (editorElem, options) {
        ...
        t.btnsDef = {
            ...
            h5: {
                fn: 'formatBlock',
                // Attention!!!
                // Source code was changed 06.12.19 for adding h5 button custom title!!!
                title: 'Стандартный'
                // title: h + ' 5'
            },
            h6: {
                fn: 'formatBlock',
                // Attention!!!
                // Source code was changed 06.12.19 for adding h6 button custom title!!!
                title: 'Голубой'
                // title: h + ' 6'
            },
            subscript: {
    ...
    Trumbowyg.prototype = {
        ...
        buildBtn: function (btnName) { // btnName is name of the button
            var t = this,
                ...
                // Attention!!!
                // Source code was changed 06.12.19 for adding h5, h6 buttons text!!!
                customBtn = btnName === 'h5' ? '<span>Заголовок</span>'
                    : btnName === 'h6' ? '<span>Заголовок</span>'
